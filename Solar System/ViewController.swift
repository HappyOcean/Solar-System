...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let earth = planet(geometry: SCNSphere(radius: 0.2), diffuse: #imageLiteral(resourceName: "Earth day"), specular: nil, emission: #imageLiteral(resourceName: "Earth Emission"), normal: nil, position: SCNVector3(1.2 ,0 , 0))
